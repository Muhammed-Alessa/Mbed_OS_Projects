...
## Description
Generates multiplication questions and lets the user enter answers over serial.
...
## Source Inspiration
Dogan Ibrahim, *ARM-based Microcontroller Projects Using mbed*, Section 8.12.
